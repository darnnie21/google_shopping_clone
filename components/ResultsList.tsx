    ...
    <div className='flex md:px-5'>
      ...
      <div className='w-36 md:w-64'>
        {results.map(pageResult => (
          <div
            ...
            className='space-y-2'
          >
            {pageResult.content.results.filters?.map(
              (filter, i) => (
                <div
                  key={i}
      ...
      <div className='px-5 md:p-10 md:pt-0 space-y-5 flex-1'>
        {results.map((pageResult, i) => (
          <div
            key={pageResult.job_id}
            className='grid grid-col-1 md:grid-col-2 lg:grid-cols-3 xl:grid-cols-4 gap-3'
          >
            {i !== 0 && (
              <hr className='w-full col-span-full' />
            )}

            <div className='md:col-span-2 lg:clo-span-3 xl:col-span-4 py-5'>
              ...
              item => (
                ...
                >
                  ...
                  <div className='px-5 py-2 not-italic'>
                    ...
                    <p className='text-[#1866D2] font-semibold'>
                      {item.merchant.name}
                    </p>
                  </div>
                </Link>
