...
const ProductPage: React.FC<ProductPageProps> = async ({
  ...
  const response = await fetch(
    getFetchUrl(`api/shopping/product/${id}`)
  );

  const productData =
    (await response.json()) as ProductData;
    ...
    <div className='p-12 pt-0'>
      ...
      <section className='flex flex-col lg:flex-row mt-5 md:mt-0'>
        <div className='md:p-10 md:pl-0 mx-auto'>
          <div className='flex gap-4'>
            <img
              ...
              alt=''
              className='h-100 w-80 p-5 border rounded-md object-contain'
            />
        ...
        <div className='pt-10 flex-1'>
          <div>
            {productData.content.pricing.online[0]
              .details && (
              <>
                ...
                <div className='flex space-x-4'>
                  ...
                  {productData.content.pricing.online
                    .length > 1 && (
